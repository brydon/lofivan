...
- A white "click to listen" hint gently floats and pulses at the center of the screen until the first click, tap, or keypress, then disappears for the rest of that page visit. Playback starting by itself does not dismiss it. Respect reduced-motion preferences.
